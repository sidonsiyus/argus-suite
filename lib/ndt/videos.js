...
export const VIDEOS = {
  ...
  /* ── Unit IV ── */
  "4.1": [{ id: "1fusgvvgGGs", title: "Ultrasonic testing explained — pipeline & weld inspection" }],
  "4.2": [{ id: "1fusgvvgGGs", title: "Ultrasonic testing — transducers & the piezoelectric probe" }],
  "4.3": [{ id: "1fusgvvgGGs", title: "Ultrasonic testing — pulse-echo & transmission methods" }],
  "4.4": [{ id: "1fusgvvgGGs", title: "Ultrasonic testing — straight & angle beam inspection" }],
  "4.5": [{ id: "1fusgvvgGGs", title: "Ultrasonic testing — instrumentation & A/B/C-scan" }],
  "4.6": [
    { id: "EuWpYY8ydIk", title: "Phased array ultrasonic testing (PAUT) explained simply" },
    { id: "pFbfpRD0xY8", title: "Phased array inspections (PAUT) — NDT inspection" },
  ],
  "4.7": [{ id: "EuWpYY8ydIk", title: "Advanced ultrasonics — phased array & TOFD context" }],
  "4.8": [
    { id: "zwzotEbyTjI", title: "Acoustic emission testing (AET) — how it works & why it matters" },
    { id: "FWO6-L0nePA", title: "Acoustic emission testing — with animation" },
  ],
  "4.9": [
    { id: "y7wnqT-P6lI", title: "Acoustic emission testing explained (ASNT Level II & III)" },
    { id: "zwzotEbyTjI", title: "Acoustic emission — applications & source location" },
  ],

  /* ── Unit V ── */
  "5.1": [
    { id: "BMuRKahAghA", title: "Radiographic testing — X-ray & gamma, industrial NDT" },
    { id: "cSbC6Kww0QQ", title: "Radiographic testing (NDT) — principle & interaction" },
  ],
  "5.2": [
    { id: "75T-9wj9Q8Y", title: "Digital radiography testing (DRT)" },
    { id: "vbuHLrf8D6M", title: "Film and digital radiography for NDT" },
  ],
  "5.3": [{ id: "cSbC6Kww0QQ", title: "Radiographic testing — filters, screens & image quality" }],
  "5.4": [{ id: "BMuRKahAghA", title: "Radiography — geometry, distance & exposure" }],
  "5.5": [{ id: "cSbC6Kww0QQ", title: "Radiographic films & characteristics" }],
  "5.6": [{ id: "BMuRKahAghA", title: "Radiography — penetrameters (IQI) & exposure" }],
  "5.7": [{ id: "cSbC6Kww0QQ", title: "Radiographic equivalence & material effects" }],
  "5.8": [{ id: "BMuRKahAghA", title: "Real-time radiography & fluoroscopy context" }],
  "5.9": [
    { id: "75T-9wj9Q8Y", title: "Computed & digital radiography" },
    { id: "vbuHLrf8D6M", title: "Advanced radiography — digital & CT context" },
  ],
};
