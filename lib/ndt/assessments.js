...
export const QUIZ = {
  ...
  "5.1": [
    { q: "On a radiograph, a void (less material) appears…", options: ["Lighter than its surroundings", "Darker than its surroundings", "Green", "Invisible"], answer: 1, explain: "More radiation passes through the void, so the film darkens there." },
    { q: "How much radiation a material absorbs depends on its…", options: ["Colour", "Density, atomic number and thickness", "Magnetism", "Temperature"], answer: 1, explain: "Denser, higher-Z and thicker material attenuates more." },
    { q: "A portable radiation source needing no electrical power is a…", options: ["X-ray tube", "Gamma isotope source", "Laser", "Magnet"], answer: 1, explain: "Gamma sources like Ir-192 emit without power — useful in the field." },
  ],
  "5.2": [
    { q: "Film-based radiography requires…", options: ["No processing", "Chemical development of a latent image", "A magnet", "A couplant"], answer: 1, explain: "The exposed film's latent image is chemically developed into a permanent radiograph." },
    { q: "Computed radiography (CR) uses a…", options: ["Flat-panel detector", "Reusable imaging plate read by a laser scanner", "Roll of film", "Gamma source"], answer: 1, explain: "The reusable phosphor plate stores a latent image read out digitally and erased." },
    { q: "A benefit of digital radiography over film is…", options: ["Higher chemical use", "Instant, processable, easily-stored images", "Lower resolution always", "Needing a darkroom"], answer: 1, explain: "Digital methods are fast, chemical-free and easy to process and archive." },
  ],
  "5.3": [
    { q: "A filter in the beam mainly…", options: ["Adds colour", "Absorbs soft, scattered radiation to improve contrast", "Cools the tube", "Magnetises the part"], answer: 1, explain: "Hardening the beam and cutting scatter improves clarity and contrast." },
    { q: "Intensifying screens allow…", options: ["Longer exposures", "Shorter exposures for the required density", "No image", "Magnetisation"], answer: 1, explain: "They amplify the latent image so less exposure is needed." },
    { q: "Which screen is favoured for sharpness?", options: ["Fluorescent", "Lead", "Plastic", "No screen"], answer: 1, explain: "Lead screens emit electrons and absorb scatter, favouring sharpness; fluorescent favours speed." },
  ],
  "5.4": [
    { q: "Geometric unsharpness (edge blur) is reduced by a…", options: ["Larger focal spot", "Smaller focal spot", "Shorter distance", "Bigger source"], answer: 1, explain: "A smaller focal spot casts a sharper shadow — less penumbra." },
    { q: "The inverse-square law says doubling the distance…", options: ["Doubles intensity", "Halves intensity", "Quarters intensity", "No change"], answer: 2, explain: "Intensity ∝ 1/distance², so 2× distance → 1/4 intensity." },
    { q: "For the sharpest image you want the part…", options: ["Far from the film", "Close to the film", "Rotating", "Heated"], answer: 1, explain: "Small source, part near film and long source-to-film distance give the crispest image." },
  ],
  "5.5": [
    { q: "The steepness of the characteristic (H&D) curve represents the film's…", options: ["Speed", "Contrast", "Colour", "Weight"], answer: 1, explain: "A steeper curve means a bigger density change per exposure change — higher contrast." },
    { q: "Finer film grain gives…", options: ["Lower resolution", "Higher resolution but needs more exposure", "No image", "More scatter"], answer: 1, explain: "Fine grain resolves smaller detail but is slower (needs more exposure)." },
    { q: "The characteristic curve plots film density against…", options: ["Temperature", "Log relative exposure", "Distance", "Atomic number"], answer: 1, explain: "It's density vs log relative exposure — the S-shaped H&D curve." },
  ],
  "5.6": [
    { q: "A penetrameter (IQI) is used to…", options: ["Find flaws directly", "Prove the radiograph achieved the required sensitivity", "Cool the tube", "Magnetise the part"], answer: 1, explain: "If its required feature is visible, the image could reveal a flaw of that size." },
    { q: "If the required IQI feature is NOT visible, the radiograph is…", options: ["Still valid", "Invalid / unproven sensitivity", "Higher quality", "Magnetic"], answer: 1, explain: "No visible IQI feature means sensitivity is unproven — the shot is rejected." },
    { q: "An exposure chart relates thickness and energy to…", options: ["Film colour", "The exposure (mA·min) needed", "The magnetism", "The temperature"], answer: 1, explain: "It gives settings for a correctly-dense film, reducing guesswork and retakes." },
  ],
  "5.7": [
    { q: "A radiographic equivalence factor converts a material's thickness to…", options: ["Its weight", "An equivalent reference-material thickness", "Its colour", "Its temperature"], answer: 1, explain: "Multiply actual thickness by the factor to use a reference exposure chart." },
    { q: "Which drives a material's attenuation the most?", options: ["Its colour", "Density and atomic number", "Its shape", "Its temperature"], answer: 1, explain: "Higher density and atomic number absorb more radiation." },
    { q: "Compared with steel, aluminium of the same thickness attenuates…", options: ["More", "Much less", "The same", "Not at all"], answer: 1, explain: "Aluminium is lighter and lower-Z, so it has a low equivalence factor." },
  ],
  "5.8": [
    { q: "Fluoroscopy provides a…", options: ["Permanent high-res film", "Real-time, moving radiographic image", "Magnetic map", "Dye indication"], answer: 1, explain: "The image is live on a screen, so the part can be moved while viewing." },
    { q: "Xeroradiography records the image on a…", options: ["Silver-halide film", "Charged electrostatic plate (edge-enhanced)", "Magnet", "Imaging plate"], answer: 1, explain: "The electrostatic process gives a static, edge-enhanced image." },
    { q: "A trade-off of fluoroscopy versus film is…", options: ["Higher resolution", "Lower resolution but real-time motion", "No radiation", "It's magnetic"], answer: 1, explain: "You gain live inspection and speed but lose some resolution and the film record." },
  ],
  "5.9": [
    { q: "Computed Radiography (CR) uses a…", options: ["Roll of film", "Reusable imaging plate read out digitally", "Gamma source", "Magnet"], answer: 1, explain: "The reusable phosphor plate is exposed, scanned into a digital image, then erased." },
    { q: "Computed Tomography (CT) produces…", options: ["A single flat shadow", "3-D cross-sections reconstructed from many views", "A magnetic map", "A dye indication"], answer: 1, explain: "Many projections are reconstructed into slices and stacked into a 3-D model." },
    { q: "CT's big advantage over a flat radiograph is that it…", options: ["Is cheaper", "Resolves a flaw's true position in 3-D", "Needs no equipment", "Uses no radiation"], answer: 1, explain: "It avoids the superimposition of a 2-D radiograph, locating flaws in three dimensions." },
  ],
