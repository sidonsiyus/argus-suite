...
// Faculty deliverables tracker (Google Sheet the faculty fill in daily).
const DELIVERABLES_LINK =
  "https://docs.google.com/spreadsheets/d/1NAsM732CNXSMwwTayexcZGgwGxHIRBI8Ysywtf-tRwc/edit?gid=856273215#gid=856273215";
...
export function fixedTasks() {
  return [
    { fixed_key: "deliverables", title: "Update faculty deliverables (Google Sheet)", link: DELIVERABLES_LINK, deadline: "before 3:00 PM" },
    { fixed_key: "campus", title: "Update campus reporting document (MH COCKPIT)", goto: "attendance", gotoSub: "report", deadline: "before 12:30 PM" },
    { fixed_key: "attendance_msg", title: "Send today's attendance report message", goto: "attendance", gotoSub: "report", deadline: "before 3:00 PM" },
  ];
}
